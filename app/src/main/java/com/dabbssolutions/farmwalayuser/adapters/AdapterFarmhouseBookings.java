...
public class AdapterFarmhouseBookings extends BaseAdapter {
    ArrayList<bookings> bookings;
    Context context;
    int view;
    String s;
    public AdapterFarmhouseBookings(ArrayList<bookings> bookings, Context context, int view){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(a.getFullName()!=null) {
            ...
            FarmName.setText(a.getFarmhouseName());
