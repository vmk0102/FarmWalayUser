...
public class farmhouseFeaturesDao {


    public String insertFarmhouseFeatures(farmhousefeatures f, Context context) {
        ...
        try {
            ...
            String postReceiverUrl = "http://dabbssolutions.org/api/farmHouseFeaturesAPI/addFarmHouseFeature.php";//https://www.pakistanscrabble.org/api.php";
...
*/
    ...
    public void deleteFarmhouseFeature(farmhousefeatures f, Context context){
    ...
    public String getAllFarmhouseFeatures(Context context,farmhouses f){
        ...
        try {
            ...
            String getUrl = "http://dabbssolutions.org/api/farmHouseFeaturesAPI/getAllFarmHouseFeature.php";//https://www.pakistanscrabble.org/api.php";
